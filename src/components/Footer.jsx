            ...
            <StyledFooter>
                ...
                <div className='section'>
                    ...
                    <div className='social-links'>
                        <a href={contactUs.socialLinks.instagram} target='_blank' rel='noreferrer'>
                            <FaInstagram />
                        </a>
                        <a href={contactUs.socialLinks.youtube} target='_blank' rel='noreferrer'>
                            <FaYoutube />
                        </a>
                        <a href={contactUs.socialLinks.facebook} target='_blank' rel='noreferrer'>
                            <FaFacebookF />
                        </a>
                    </div>
                </div>
