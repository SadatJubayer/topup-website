...
const StyledNav = styled.nav`
    ...
    .mobileNav {
        ...
        .menu-icon {
            ${tw`absolute right-5 transform -translate-y-1/2`}
            svg {
                ${tw`h-8 w-8`}
                g {
        ...
        .mobile-menu {
            ${tw`absolute right-5 top-full mt-5 width[210px] bg-white shadow-lg px-5 py-4 grid gap-1 grid-cols-2 rounded-lg`}
            .hireButton {
                a {
